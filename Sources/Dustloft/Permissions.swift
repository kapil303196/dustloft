...
enum Permissions {
    ...
    /// started with, so this correctly returns false until Dustloft relaunches.
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 0) {
            ...
            VStack(alignment: .leading, spacing: DS.s3) {
                ...
                Text("Let Dustloft see your disk")
                    .font(.system(size: 22, weight: .semibold))
                    .foregroundStyle(DS.text)
                Text("macOS hides most of your disk from apps. Without Full Disk Access, Dustloft cannot measure your Trash, app data or device backups — and it would quietly under-report how much space you could get back.")
                    .font(DS.body())
            ...
            VStack(alignment: .leading, spacing: DS.s4) {
                ...
                step(2, "Switch on Dustloft", "If it is not listed, use + and choose Dustloft, or drag it in from the Finder window.")
                step(3, "Relaunch Dustloft",
                     "macOS only applies Full Disk Access to a freshly launched app, so Dustloft has to restart once. This is a macOS rule, not a Dustloft one.")
            }
            .padding(DS.s6)
            ...
            HStack(spacing: DS.s3) {
                if granted {
                    ...
                    Button("Relaunch Dustloft") { Permissions.relaunch() }
                    ...
                    Button("Show Dustloft in Finder") { Permissions.revealApp() }
                        .buttonStyle(SecondaryButton())
